(function($) {
  ...
  async function setUpDataAssoc() {
    ...
    const res = await fetch('https://23c6902811494393ad2cea6ff8f72d75.vfs.cloud9.us-east-1.amazonaws.com//managements/');
              ...
              .then((willDelete) => {
                if (willDelete) {}
                  ...
                  async function setUpDataTable1() {
                    ...
                    const response = await fetch(`https://23c6902811494393ad2cea6ff8f72d75.vfs.cloud9.us-east-1.amazonaws.com/managements/` + a)
                    ...
                    await fetch(`https://23c6902811494393ad2cea6ff8f72d75.vfs.cloud9.us-east-1.amazonaws.com/managements/` + a, { method: "DELETE" })
